...
export class VolumeRequest extends SpeakeasyBase {
    /**
 ...
 * conversation
 */
export class VolumeResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class VolumeResponse extends SpeakeasyBase {
    /**
