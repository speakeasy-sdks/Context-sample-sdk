...
export class EstimatedCostRequest extends SpeakeasyBase {
    /**
 ...
 * conversation
 */
export class EstimatedCostResponseBody extends SpeakeasyBase {
    @SpeakeasyMetadata()
...
export class EstimatedCostResponse extends SpeakeasyBase {
    /**
     ...
     */
    @SpeakeasyMetadata()
    object?: EstimatedCostResponseBody;
}
